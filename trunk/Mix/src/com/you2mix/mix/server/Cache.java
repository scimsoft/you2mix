...
public class Cache {
  ...
  private static String createVideoId(Key videoKey) {
		// TODO Auto-generated method stub
		return VIDEO_PREFIX + KeyFactory.keyToString(videoKey);
	}
...
/**
  ...
  @SuppressWarnings("unchecked")
  public List<Key> getNoteKeys(Key surfaceKey) {
    return (List<Key>) memcache.get(surfaceKey);
  }
  ...
  public List<Key> putNoteKeys(Key surfaceKey, List<Key> noteKeys) {
	    memcache.put(surfaceKey, noteKeys);
	    return noteKeys;
	  }
