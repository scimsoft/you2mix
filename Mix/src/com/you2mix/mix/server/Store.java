...
public class Store {
  ...
  public class Api {
    ...
    public Author getOrCreateNewAuthor(User user) {
      try {
        ...
        final Surface surface = new Surface("My First YouTube Mix");
    ...
    public Video getVideo(Key key){
    	return manager.getObjectById(Video.class,key);
    }
    ...
    public Video saveVideo(Video video){
    	...
    	return manager.makePersistent(video);
  ...
  public static class Note {
     ...
     * @param height
     */
    public Note(Author owner, int x, int y, int width, int height,Video video) {
      this.x = x;
      this.y = y;
      this.width = width;
      this.height = height;
  ...
  /**
   * A JDO object representing a Video.
   */
